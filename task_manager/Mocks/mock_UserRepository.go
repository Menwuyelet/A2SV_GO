...
import (
	context "context"
	models "task_manager/Domain/models"
...
func (_m *MockUserRepository) Create(ctx context.Context, user models.User) (bool, error) {
...
func (_c *MockUserRepository_Create_Call) Return(_a0 bool, _a1 error) *MockUserRepository_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockUserRepository_Create_Call) RunAndReturn(run func(context.Context, models.User) (bool, error)) *MockUserRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
